Ext.define('DWork.view.gridPickerNewTeachRules', {
    extend: 'Ext.form.field.Picker',
    alias: 'widget.gridpickernewteachrules',
    editable: false,
    id: 'gridPickerNewTeachRules',
    autoDestroy: true,
    listeners: {
        ...
        collapse: function (el) {
            Ext.getCmp('teacherNewRulesGrid').remove();
        },
